...
def display_boiler_img(boiler_stat,fuel_stat,water_stat):
	...
	plc_img = "boiler_{}.png"
	if fuel_stat == 'off' and self_stat == 'on' and water_stat == 'on':
		state = 'overflow'
	elif fuel_stat == 'off' and self_stat == 'off' and water_stat == 'off':
		state = 'close_emp_NA'
	elif fuel_stat == 'off' and self_stat == 'on' and water_stat == 'off':
		state = 'open_emp_NA'
	elif fuel_stat == 'off' and self_stat == 'off' and water_stat == 'on':
		state = 'closed_full'
#START FUEL LOW
	if fuel_stat == 'low' and self_stat == 'on' and water_stat == 'on':
		state = 'low'
	elif fuel_stat == 'low' and self_stat == 'off' and water_stat == 'off':
		state = 'close_emp_NA'
	elif fuel_stat == 'low' and self_stat == 'on' and water_stat == 'off':
		state = 'open_emp_NA'
	elif fuel_stat == 'low' and self_stat == 'off' and water_stat == 'on':
		state = 'closed_full_low'
#START FUEL NORM
	if fuel_stat == 'norm' and self_stat == 'on' and water_stat == 'on':
		state = 'norm'
	elif fuel_stat == 'norm' and self_stat == 'off' and water_stat == 'off':
		state = 'close_emp_NA'
	elif fuel_stat == 'norm' and self_stat == 'on' and water_stat == 'off':
		state = 'open_emp_NA'
	elif fuel_stat == 'norm' and self_stat == 'off' and water_stat == 'on':
		state = 'closed_full_norm'
#START FUEL MAX
	if fuel_stat == 'max' and self_stat == 'on' and water_stat == 'on':
		state = 'max'
	elif fuel_stat == 'max' and self_stat == 'off' and water_stat == 'off':
		state = 'close_emp_NA'
	elif fuel_stat == 'max' and self_stat == 'on' and water_stat == 'off':
		state = 'open_emp_NA'
	elif fuel_stat == 'max' and self_stat == 'off' and water_stat == 'on':
...
def display_turbine_img(turbine_stat,boiler_stat,fuel_stat):
	...
	if self_stat == 'on' and boiler_stat == 'on' and fuel_stat == 'low':
		state = 'low'
	elif self_stat == 'on' and boiler_stat =='on' and fuel_stat =='norm':
		state = 'norm'
	elif self_stat == 'on' and boiler_stat =='on' and fuel_stat =='max':
		state = 'max'
	else:
		state = 'off'
	return plc_img.format(state)
